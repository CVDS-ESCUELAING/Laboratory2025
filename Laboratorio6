...
### Nuevos requisitos
Utilizando el proyecto de reservas desarrollado en las sesiones anteriores tenga en cuenta las siguientes funcionalidades:
1) Autenticación: El sistema de reservas deberá tener un sistema de autenticación ahora los usuarios podrán gestionar sus reservas; una vez que el usuario inicia sesión podrá ver sus reservas.
